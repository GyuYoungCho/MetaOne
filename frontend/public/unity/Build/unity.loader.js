    ...
    if ("symbolsUrl" != e) {
      ...
      n || (n = l.downloadProgress[e] = { started: !1, finished: !1, lengthComputable: !1, total: 0, loaded: 0 }),
        "object" != typeof t ||
          ...
          (n.started || ((n.started = !0), (n.lengthComputable = t.lengthComputable), (n.total = t.total)),
          (n.loaded = t.loaded),
    ...
    return new Promise(function (t, r) {
      ...
      var n =
        l.companyName && l.productName
          ? new l.XMLHttpRequest({ companyName: l.companyName, productName: l.productName, cacheControl: l.cacheControl(l[e]) })
          : new XMLHttpRequest();
      n.open("GET", l[e]),
      ...
      l.addRunDependency("dataUrl"),
        e.then(function (e) {
          ...
          for (r += 4; r < o; ) {
            ...
            r += i;
            for (var u = 0, c = d.indexOf("/", u) + 1; c > 0; u = c, c = d.indexOf("/", u) + 1)
      ...
      function n() {
        ...
        try {
          ...
          (u.onupgradeneeded = function (e) {
            var t = e.target.result.createObjectStore(i.name, { keyPath: "url" });
      ...
      l.SystemInfo.hasWebGL
        ? l.SystemInfo.hasWasm
          ? (1 == l.SystemInfo.hasWebGL &&
              l.print('Warning: Your browser does not support "WebGL 2.0" Graphics API, switching to "WebGL 1.0"'),
