function createUnityInstance(e, r, n) {
  ...
  function i(e, r) {
    if ("symbolsUrl" != e) {
      ...
      t || (t = u.downloadProgress[e] = { started: !1, finished: !1, lengthComputable: !1, total: 0, loaded: 0 }),
        "object" != typeof r ||
          ("progress" != r.type && "load" != r.type) ||
          (t.started || ((t.started = !0), (t.lengthComputable = r.lengthComputable), (t.total = r.total)),
          (t.loaded = r.loaded),
      ...
      u.addRunDependency("dataUrl"),
        e.then(function (e) {
          ...
          for (n += 4; n < o; ) {
            ...
            n += s;
            for (var d = 0, c = l.indexOf("/", d) + 1; c > 0; d = c, c = l.indexOf("/", d) + 1)
      ...
      u.SystemInfo.hasWebGL
        ? u.SystemInfo.hasWasm
          ? (1 == u.SystemInfo.hasWebGL &&
              u.print('Warning: Your browser does not support "WebGL 2.0" Graphics API, switching to "WebGL 1.0"'),
